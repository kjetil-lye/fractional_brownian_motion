...
inline std::vector<double>
fractional_brownian_bridge_2d(double H, int nx, const std::vector<double> &X) {
...
inline std::vector<double>
fractional_brownian_bridge_1d(double H, int nx, const std::vector<double> &X) {
...
inline void fractional_brownian_bridge_1d(double *data_out_pointer, double H,
  ...
  // We do not want to set data on the boundary
  auto not_on_boundary = [&](int x) { return x != 0 && x != nx; };
