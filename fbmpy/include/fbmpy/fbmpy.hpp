...
inline boost::python::numpy::ndarray generate_fractional_brownian_bridge(double H, int nx, const boost::python::numpy::ndarray& X) {
    ...
    fbm::fractional_brownian_bridge_3d(reinterpret_cast<double*>(bridge_data.get_data()),
                                       nx,
                                       H,
